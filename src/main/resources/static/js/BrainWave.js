...
function searchBeaches() {
    ...
    output.innerHTML = "<img src='http://cdnimages.magicseaweed.com/star_filled.png'/>";
...
function getSurfData(beachName, beachId) {
    ...
    surfBody.innerHTML = "<tr> <td colspan=4><img class='max-width: 100%' src='img/loading.gif'/></td><tr>"
